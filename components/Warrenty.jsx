            ...
            <div className={`min-h-screen bg-gray-50 ${poppins.className}`}>
                ...
                <header className="bg-white py-12 sm:py-16 lg:py-20 border-b border-gray-200">
                    <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
                        ...
                        <p className="text-lg sm:text-xl lg:text-2xl text-gray-600 font-medium px-4">
                            FOR PEACE OF MIND, WE INCLUDE AN RAC WARRANTY ON ALL OF THE VEHICLES WE SELL.
                        </p>
                    </div>
                </header>

                {/* Main Content: Warranty Inclusion - Responsive Grid */}
                <section className="py-12 lg:py-20">
                    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
                            {/* Text Content */}
                            <div className="space-y-6">
                                <h2 className={`text-3xl sm:text-4xl font-bold text-gray-800 ${montserrat.className}`}>
                                ...
                                <div className="p-5 sm:p-6 bg-blue-50 border-l-4 border-blue-600 text-blue-800 rounded-lg">
                                    <p className="font-semibold text-lg">Your Assurance:</p>
                            ...
                            {/* Image 1: RAC Warranty - Responsive */}
                            <div className="flex justify-center items-center">
                                <div className="w-full max-w-lg mx-auto bg-white rounded-xl overflow-hidden">
                                    <Image
                ...
                {/* Section 2: Trust and Maintenance - Fixed Order & Responsive */}
                    ...
                    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                            ...
                            <div className="flex justify-center items-center order-1 lg:order-2">
                                <div className="w-full max-w-lg mx-auto bg-gray-100 rounded-xl shadow-lg overflow-hidden p-4 sm:p-6">
                                    <Image
