    ...
    <section className={`py-24 px-6 lg:px-12 bg-white overflow-hidden ${montserrat.variable} ${poppins.variable}`}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 xl:gap-20 items-stretch">
          ...
          {/* Left: Contact Info – Premium Black Card */}
          <div className="bg-black text-white rounded-3xl p-10 lg:p-14 shadow-2xl flex flex-col justify-between">
          ...
          {/* Right: Google Map – Bold Black Frame */}
          <div className="relative rounded-3xl overflow-hidden  border border-gray-300">
            <iframe
        ...
        {/* Bottom CTA */}
        <div className="text-center mt-20 p-10 bg-gray-50 rounded-2xl border border-gray-200">
