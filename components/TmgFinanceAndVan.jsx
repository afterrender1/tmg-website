...
const TmgFinanceAndVan = () => {
  ...
  return (
    // Applied background changed from gray-50 to white for maximum cleanliness
    <section className={`bg-white text-gray-900 py-24 px-4 sm:px-8 lg:px-16 ${montserrat.variable} ${poppins.variable} font-sans`}>
      <div className="max-w-7xl mx-auto space-y-24">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 bg-white p-0 rounded-2xl border border-gray-200  shadow-sm transition duration-300">
          ...
          <div className="relative w-full lg:w-1/2 h-80 md:h-96 rounded-t-2xl lg:rounded-l-2xl lg:rounded-tr-none overflow-hidden border-b lg:border-r border-gray-100">
            <Image
              ...
              fill
              // Reduced visual noise in image transitions
        ...
        <div className="flex flex-col lg:flex-row-reverse items-center gap-10 bg-white p-0 rounded-2xl border border-gray-200 shadow-sm transition duration-300 ">
